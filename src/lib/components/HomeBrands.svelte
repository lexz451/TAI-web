...
<IntersectionObserver let:intersecting let:top>
	<section
		...
		class="content-split-container section bg-theme-blue z-1"
		data-section="3"
	>
		...
		{#if top < 200}
			<div class="left-container" transition:fade={{ duration: 200, delay: 0 }}>
				<h1 class="text-large text-theme-green mr-auto mb-0">Who does participatory strategy?</h1>
				<p class="text-white">
		...
		<div class="fixed-container">
			<div class="inner">
				<div class="brand-circles">
					...
					<div class="brand-circle bg-white p-4">
						<img class="inner_image" src="$lib/assets/images/brands/mamacash.png" alt="Mama Cash" />
					</div>
